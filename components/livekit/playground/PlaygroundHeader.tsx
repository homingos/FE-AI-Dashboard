...
// Renamed and updated the logo component
const FlamLogo = () => (
    ...
    >
      <div className="flex items-center gap-3 basis-2/3">
        <div className="flex lg:basis-1/2">
          {/* Use the new FlamLogo component */}
          <FlamLogo />
        </div>
...
// This SVG is no longer used by default but is kept here in case you want to switch back
const LKLogo = () => (
  <svg
    width="28"
    height="28"
