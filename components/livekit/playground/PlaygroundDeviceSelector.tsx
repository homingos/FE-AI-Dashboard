...
export const PlaygroundDeviceSelector = ({
  ...
  return (
    <div className="relative">
      ...
      <div
        className="absolute right-0 top-full mt-1 bg-gray-800 text-gray-300 border border-gray-700 rounded-sm z-10 w-48"
        style={{
            ...
            <div
              ...
              className={`${
                device.deviceId === deviceSelect.activeDeviceId
                  ...
                  : "text-gray-400"
              } bg-gray-900 text-xs py-2 px-3 cursor-pointer hover:bg-gray-700/50 hover:text-white truncate`}
              key={index}
            >
              {device.label}
            </div>
