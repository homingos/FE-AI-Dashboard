...
// Define the ToggleSource type ourselves, as it's not exported.
// These are the only sources the TrackToggle component accepts.
type ToggleSource =
  | Track.Source.Camera
...
type ConfigurationPanelItemProps = {
  title: string;
  children?: ReactNode;
  source?: ToggleSource; // Use our local ToggleSource type
  collapsible?: boolean;
